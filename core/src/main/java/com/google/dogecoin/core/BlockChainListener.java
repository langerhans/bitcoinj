...
public interface BlockChainListener {
     ...
     * us via either {@link #receiveFromBlock(Transaction, StoredBlock, com.google.dogecoin.core.BlockChain.NewBlockType, int)}
     * or {@link #notifyTransactionIsInBlock(Sha256Hash, StoredBlock, com.google.dogecoin.core.BlockChain.NewBlockType, int)}.
