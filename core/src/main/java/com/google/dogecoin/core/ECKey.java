...
public class ECKey implements EncryptableItem, Serializable {
     ...
     * @throws com.google.dogecoin.core.ECKey.MissingPrivateKeyException if the private key is missing or encrypted.
     */
    public byte[] toASN1() {
        try {
     ...
     * usually encoded using ASN.1 format, so you want {@link com.google.dogecoin.core.ECKey.ECDSASignature#toASN1()}
     ...
     * @throws com.google.dogecoin.core.ECKey.MissingPrivateKeyException if the private key bytes are missing/encrypted.
     */
