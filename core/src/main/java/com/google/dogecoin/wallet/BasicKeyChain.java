...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws com.google.dogecoin.store.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws com.google.dogecoin.store.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
    ...
    /**
     * Convenience wrapper around {@link #toEncrypted(com.google.dogecoin.crypto.KeyCrypter,
