...
import com.google.dogecoin.core.BloomFilter;
 ...
 * {@link com.google.dogecoin.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link com.google.dogecoin.crypto.MnemonicCode},
 ...
 * {@link com.google.dogecoin.crypto.DeterministicKey#serializePubB58()}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link com.google.dogecoin.crypto.DeterministicKey#deserializeB58(com.google.dogecoin.crypto.DeterministicKey, String)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(com.google.dogecoin.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link com.google.dogecoin.crypto.DeterministicHierarchy} and
 * {@link com.google.dogecoin.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
     ...
     * The returned key can be serialized and then passed into {@link #watch(com.google.dogecoin.crypto.DeterministicKey)}
