...
public interface EncryptableKeyChain extends KeyChain {
     ...
     * {@link #toEncrypted(com.google.dogecoin.crypto.KeyCrypter, org.spongycastle.crypto.params.KeyParameter)} with
     * {@link com.google.dogecoin.crypto.KeyCrypterScrypt} as the crypter.
     *
     ...
     * {@link com.google.dogecoin.core.Wallet.SendRequest#aesKey} field before asking the wallet to build the send.
     *
