...
import com.google.dogecoin.crypto.ChildNumber;
...
/**
 * <p>A KeyChainGroup is used by the {@link com.google.dogecoin.core.Wallet} and
 * manages: a {@link com.google.dogecoin.wallet.BasicKeyChain} object (which will normally be empty), and zero or more
 * {@link com.google.dogecoin.wallet.DeterministicKeyChain}s. A deterministic key chain will be created lazily/on demand
...
public class KeyChainGroup {
     ...
     * For married keychains use {@link #currentAddress(com.google.dogecoin.wallet.KeyChain.KeyPurpose)}
     ...
     * <p>This method is not supposed to be used for married keychains and will throw UnsupportedOperationException if
     * the active chain is married.
     * For married keychains use {@link #freshAddress(com.google.dogecoin.wallet.KeyChain.KeyPurpose)}
     * to get a proper P2SH address</p>
     */
     ...
     * see {@link com.google.dogecoin.wallet.DeterministicKeyChain#setLookaheadSize(int)}
     ...
     * {@link com.google.dogecoin.wallet.DeterministicKeyChain#setLookaheadSize(int)}
     * for more information.
     */
     ...
     * {@link com.google.dogecoin.wallet.DeterministicKeyChain#setLookaheadThreshold(int)}
     * for more information.
     */
     ...
     *
     * @throws com.google.dogecoin.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link com.google.dogecoin.crypto.KeyCrypterScrypt}.
     *
     * @throws com.google.dogecoin.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
     ...
     * @throws com.google.dogecoin.wallet.DeterministicUpgradeRequiresPassword if the key chain group is encrypted
